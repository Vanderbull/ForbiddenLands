#ifndef VILLAGESTATE_H
#define VILLAGESTATE_H
...
class CVillageState : public CGameState
{
public:
	void Init();
	void Cleanup();
	...
	static CVillageState* Instance() {
		return &m_VillageState;
	}
...
private:
	static CVillageState m_VillageState;
