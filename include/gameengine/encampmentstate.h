#ifndef ENCAMPMENTSTATE_H
#define ENCAMPMENTSTATE_H
...
class CEncampmentState : public CGameState
{
public:
	void Init();
	void Cleanup();
	...
	static CEncampmentState* Instance() {
		return &m_EncampmentState;
	}
...
private:
	static CEncampmentState m_EncampmentState;
