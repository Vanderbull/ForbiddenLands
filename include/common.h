...
void renderPCstatus()
{
    ...
    encampButton = {current.w - 168*2, current.h - 168,160,160};
    SDL_SetRenderDrawColor(renderer, 0, 0, 0, 192);
    ...
    lookButton = {current.w - 168, current.h - 168,160,160};
    SDL_SetRenderDrawColor(renderer, 0, 0, 0, 192);
    ...
    SDL_Rect backpackButton = {current.w - 168*3, current.h - 168,160,160};
    SDL_SetRenderDrawColor(renderer, 0, 0, 0, 192);
    ...
    SDL_Rect cogButton = {current.w - 168*4, current.h - 168,160,160};
    SDL_SetRenderDrawColor(renderer, 0, 0, 0, 192);
